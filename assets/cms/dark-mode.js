  ...
  _updateCheckbox() {
    if (this.mode === LIGHT) {
      this._checkboxLabel.style.setProperty(`--${NAME}-checkbox-icon`,
          `var(--${NAME}-light-icon,url("https://image.flaticon.com/icons/svg/3731/3731718.svg"))`);
      this._checkboxLabel.textContent = this.light;
      this._darkCheckbox.checked = false;
    } else {
      this._checkboxLabel.style.setProperty(`--${NAME}-checkbox-icon`,
          `var(--${NAME}-dark-icon,url("https://image.flaticon.com/icons/svg/3731/3731715.svg"))`);
